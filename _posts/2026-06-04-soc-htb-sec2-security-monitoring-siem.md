...
> - [x] **Section 1**: [Incident Handling Process](/posts/cdsa-sec1-incident-handling/)
> - [x] **Section 2**: [Security Monitoring & SIEM Fundamentals](/posts/soc-htb-sec2-security-monitoring-siem/) *(Bạn đang ở đây)*
